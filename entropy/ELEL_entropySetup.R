...
PopID <- makePopId('ELEL.bithin.q30.iBC20m90.a65.maf03.012.indv')

g <- read.table('pntest_mean_ELEL.bithin.q30.iBC20m90.a65.maf03.recode.txt', header = F)
...
writeLDAfile(pca_df, 9)
writeLDAfile(pca_df, 10)
writeLDAfile(pca_df, 11)
